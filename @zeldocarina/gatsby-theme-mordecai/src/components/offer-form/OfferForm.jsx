...
import FormHandler from "./OfferFormHandler"
  ...
  return (
    <StyledForm onSubmit={handleSubmit}>
      ...
      <div className="input-container">
        ...
        >
          <option value="">{servicesTitle}</option>
          {services.map((service, i) => (
            <option key={i} value={service.description}>
              {service.description}
            </option>
          ))}
        </select>
      ...
      <div className="privacy-container privacy-container--offer">
        <input
          type="checkbox"
