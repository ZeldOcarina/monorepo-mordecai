				...
				<td>
					...
					<table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #222; color: #000; width: 650px; margin: 0 auto;" width="650">
										<tbody>
											<tr>
															...
															<td class="pad" style="padding-left:10px;padding-right:10px;">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #ffffff; line-height: 1.2;">
																		<p style="margin: 0; text-align: center; mso-line-height-alt: 14.399999999999999px;"><span style="font-size:42px;">We Have a New </span></p>
																		<p style="margin: 0; text-align: center; mso-line-height-alt: 50.4px;">
																		<span style="font-size:42px;">
																			${offer ? "Dental Offer" : ""}
																			${isFreeGift ? "Free Gift Request" : ""}
																			${!isFreeGift && !offer ? "Contact Request" : ""}
																	</span></p>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td class="pad" style="padding-bottom:40px;padding-left:40px;padding-right:40px;padding-top:20px;">
																<div style="font-family: 'Trebuchet MS', Tahoma, sans-serif">
																	<div class style="font-size: 12px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 18px; color: #5d5d5d; line-height: 1.5;">
																		...
																		<p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">We just got a new ${
                                      isFreeGift ? "free gift" : "contact"
                                    } request from the website!</span></p>
																		<p style="margin: 0; mso-line-height-alt: 18px;">&nbsp;</p>
																		<p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">Here is all the related data:</span></p>
																		<p style="margin: 0; mso-line-height-alt: 18px;">&nbsp;</p>
																		${buildLeadAttributeLine("First Name", first_name)}
																		${buildLeadAttributeLine("Last Name", last_name)}
																		${buildLeadAttributeLine("Email", email)}
																		${buildLeadAttributeLine("Phone Number", phone_number)}
																		${buildLeadAttributeLine("Service", service)}
																		${buildLeadAttributeLine("Message", message)}
																		${buildLeadAttributeLine("License Number", license_number)}
																		${buildLeadAttributeLine("Address", address)}
																		${buildLeadAttributeLine("City", city)}
																		${buildLeadAttributeLine("Country", country)}
																		${buildLeadAttributeLine("ZIP Code", zip_code)}
																	</div>
																</div>
															</td>
														</tr>
...
function buildLeadAttributeLine(key: string, value?: string): string | "" {
  if (!value) return ""
  return /*html*/ `<p style="margin: 0; mso-line-height-alt: 24px;"><span style="font-size:16px;">${key}: ${value}</span></p>`
}
